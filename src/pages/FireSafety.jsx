...
import { Shield, AlertTriangle, Home, Users, Wind, Phone, MapPin, ExternalLink } from 'lucide-react';
import { Card, CardHeader, CardTitle, CardContent } from "@/components/ui/card";

export default function FireSafety() {
  const beforeSteps = [
    { icon: Home, title: "Create Defensible Space", desc: "Clear vegetation 30+ meters from your home" },
    { icon: MapPin, title: "Know Evacuation Routes", desc: "Plan multiple routes and meeting locations" },
    { icon: Users, title: "Prepare Emergency Kit", desc: "Water, food, medications, documents for 72 hours" },
    { icon: Phone, title: "Emergency Contacts", desc: "Keep list of local fire departments and family" },
  ];
